...
| --------------| ---------------------- | ---------------------- | ---------------------- | ---------------------- | ---------------------- |
| 10:00 - 11:30 | -                      | 経路積分 <br> [[ノート]](lec_pathintegral.pdf) <br> [[スライド]](lec_pathintegral_slides.pdf) | 格子ゲージ理論 <br> [[スライド]](lattice_gauge_action.pdf) | クォークソルバー <br> [[スライド]](LS2024_QuarkSolver_ishikawa_20240912_v3) <br> [[サンプルコード(1D Helmholz方程式 CG solver)]](Helmholz1DCG.tar.gz) <br> [[サンプルコード (1D Wilson Fermion BiCGStab solver)]](Wilon1DBiCGStab.tar.gz) | 有限温度 <br> [[スライド]](LatticeQFTschool2024_finiteT_ohno20240913_v3.pdf) <br> [[Polyakov loop計算 jupyter notebook]](su3_polyakov_loop.ipynb) |
