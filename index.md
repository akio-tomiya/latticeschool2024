...
| 13:30 - 15:00 | 群と表現                  | 標準模型とQCDの基礎   | 格子フェルミオン  | ゼロ温度   | 量子コンピュータ |
| 15:30 - 17:00 | ハミルトン形式の場の理論   | くりこみ群と連続極限   | MCMCとHMC        | (未定)    | 機械学習        　  |
| 17:00 -       | -                        | -                    | 懇親会 (18:30-) | -         | 閉校式 (10分程度) |
...
- 対面参加:
  - 旅費補助必要: 2024/7/7 (日) 23:59 JST 旅費補助の申請は締め切りました。
...
本スクールは、
「富岳」成果創出加速プログラム hp230199「超大規模格子QCDによる新物理探索と次世代計算に向けたAI技術開発」、
