...
| 15:30 - 17:00 | 場の理論の導入II: ハミルトン形式の場の理論 <br> [[ノート]](Field_Theory.pdf) | くりこみ群と連続極限 <br> [[スライド]](くりこみ群_格子スクール.pdf) | MCMCとHMC <br> [[スライド]](lattice_school_MCMC_and_HMC_v2.pdf) <br> [[サンプルコード (円周率計算)]](pi.py) <br> [[サンプルコード (HMCを用いたガウス積分)]](hmc_gauss.py) | ハンズオン <br> [[スライド (part 1)]](Nagai_2024_場の理論part1.pdf) <br> [[part1 jupyter notebook]](juliatutorial.ipynb) <br> [[スライド (part 2)]](hands-on2024part2tomiya.pdf) <br> [[part2 解答]](kaitou_tomiya.zip) <br> [[スライド (part 3)]](Nagai_2024_場の理論part3.pdf) <br> [[part3 Juliaコード1]](tutorial3.jl) <br> [[part3 Juliaコード2]](heatbath.jl) | 機械学習 <br> [[スライド]](Letcure2024_LQCD_school_tomiya.pdf) |
